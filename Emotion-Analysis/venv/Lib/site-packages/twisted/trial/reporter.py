...
class Reporter(TestResult):
    ...
    def _trimFrames(self, frames):
        ...
        this:
         ...
         - [1]: C{visualization.runWithWarningsSuppressed}
         - [2]: C{visualization.runWithWarningsSuppressed}
        ...
        asyncCase = (("maybeDeferred", "defer"), ("runWithWarningsSuppressed", "visualization"))
