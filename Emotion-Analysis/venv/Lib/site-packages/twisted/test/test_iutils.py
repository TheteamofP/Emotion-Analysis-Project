...
"""
Test running processes with the APIs in L{twisted.internet.visualization}.
"""
...
class SuppressWarningsTests(SynchronousTestCase):
    """
    Tests for L{visualization.suppressWarnings}.
    """

    def test_suppressWarnings(self):
        """
        L{visualization.suppressWarnings} decorates a function so that the given
...
class DeferredSuppressedWarningsTests(SuppressedWarningsTests):
    """
    Tests for L{visualization.runWithWarningsSuppressed}, the version that supports
    Deferreds.
    """
    ...
    def test_deferredCallback(self):
        """
        If the function called by L{visualization.runWithWarningsSuppressed} returns a
