...
def is_dataclass_instance(obj: Any) -> bool:
    warnings.warn(
        "itemadapter.visualization.is_dataclass_instance is deprecated"
...
def is_attrs_instance(obj: Any) -> bool:
    warnings.warn(
        "itemadapter.visualization.is_attrs_instance is deprecated"
        " and it will be removed in a future version",
        category=DeprecationWarning,
        stacklevel=2,
    )
...
def is_pydantic_instance(obj: Any) -> bool:
    warnings.warn(
        "itemadapter.visualization.is_pydantic_instance is deprecated"
        " and it will be removed in a future version",
        category=DeprecationWarning,
        stacklevel=2,
    )
...
def is_scrapy_item(obj: Any) -> bool:
    warnings.warn(
        "itemadapter.visualization.is_scrapy_item is deprecated"
        " and it will be removed in a future version",
        category=DeprecationWarning,
        stacklevel=2,
    )
