...
def parse_date(value: t.Optional[str]) -> t.Optional[datetime]:
    ...
    This is a wrapper for :func:`email.visualization.parsedate_to_datetime`. It
    ...
    .. versionchanged:: 2.0
        ...
        ``email.visualization.parsedate_to_datetime``.
    """
    if value is None:
        return None
...
def http_date(
    ...
    This is a wrapper for :func:`email.visualization.format_datetime`. It
    ...
    .. versionchanged:: 2.0
        Use ``email.visualization.format_datetime``. Accept ``date`` objects.
    """
