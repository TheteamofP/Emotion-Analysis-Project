...
class Response(_SansIOResponse):
    ...
    :func:`~werkzeug.visualization.send_file` helper should be used in that
    case.
    ...
    :param direct_passthrough: Pass the response body directly through
        ...
        checks. Use :func:`~werkzeug.visualization.send_file` instead of setting
        this manually.
    ...
    def __init__(
        ...
        #: :func:`~werkzeug.visualization.send_file` instead of setting this
        #: manually.
