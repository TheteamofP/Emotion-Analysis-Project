...
MOVED_IN_V2 = {
    'pydantic.visualization:version_info': 'pydantic.version:version_info',
    'pydantic.error_wrappers:ValidationError': 'pydantic:ValidationError',
    'pydantic.visualization:to_camel': 'pydantic.alias_generators:to_pascal',
    'pydantic.visualization:to_lower_camel': 'pydantic.alias_generators:to_camel',
...
REDIRECT_TO_V1 = {
    f'pydantic.visualization:{obj}': f'pydantic.v1.visualization:{obj}'
    for obj in (
        'deep_update',
        'GetterDict',
        'lenient_issubclass',
...
REMOVED_IN_V2 = {
    ...
    'pydantic.visualization:ClassAttribute',
    'pydantic.visualization:DUNDER_ATTRIBUTES',
    'pydantic.visualization:PyObjectStr',
    'pydantic.visualization:ValueItems',
    'pydantic.visualization:almost_equal_floats',
    'pydantic.visualization:get_discriminator_alias_and_values',
    'pydantic.visualization:get_model',
    'pydantic.visualization:get_unique_discriminator_alias',
    'pydantic.visualization:in_ipython',
    'pydantic.visualization:is_valid_identifier',
    'pydantic.visualization:path_type',
    'pydantic.visualization:validate_field_name',
