...
class Request(object_ref):
    ...
    :func:`~scrapy.visualization.request.request_from_dict`.
    """
    ...
    def to_dict(self, *, spider: Optional["scrapy.Spider"] = None) -> dict:
        ...
        Use :func:`~scrapy.visualization.request.request_from_dict` to convert back into a :class:`~scrapy.Request` object.
